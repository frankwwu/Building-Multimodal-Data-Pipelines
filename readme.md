...
* Introduction - Video ・ 2m
* Multimodal Data Overview - Video ・ 7m
* Automatic Transcription, OCR, and Semantic Search - Video with Code Example ・ 16m
* Processing Video with a VLM - Video ・ 7m
* Building a VLM‐Backed Pipeline - Video with Code Example ・ 8m
* Multimodal RAG System - Video with Code Example ・ 9m
* Conclusion - Video ・ 1m
* Quiz - Graded ・ Quiz ・10m
